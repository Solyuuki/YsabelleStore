...
- Explain why each affected area changed.
...
- [ ] I changed only files within my assigned scope.
- [ ] I received approval for shared or cross-owner files.
- [ ] I documented affected files in my implementation artifact folder.
- [ ] I did not include unrelated edits.

## Merge Checklist

- [ ] Branch follows `member/version/type/task-name`.
