-- Sprint 1 database foundation migration for YsabelleStore.
-- Generated from database/prisma/schema.prisma with Prisma migrate diff.
-- This file is a reviewable migration artifact; apply only against an approved local MySQL database.
