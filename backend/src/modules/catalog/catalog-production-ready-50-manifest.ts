...
export const PRODUCTION_CATALOG_50_TARGETS = [
  {
    ...
    description: "Cheese-flavored Jack ‘n Jill Piattos potato crisps in a supersized pack, made for a crunchy savory snack."
  },
  {
    sourceProductId: "P352",
    manufacturerBarcode: "4800010076073",
    description: "Peanut butter cream-filled sandwich cookies with crisp biscuit layers and a sweet, nutty filling."
  },
  {
    sourceProductId: "P361",
    manufacturerBarcode: "4800016082641",
    description: "Crisp Magic Flakes crackers with a savory cheese flavor, suitable for snacks or baon."
  },
  {
    sourceProductId: "P023",
    manufacturerBarcode: "4806502721445",
    description: "Gardenia California Raisin Loaf made with raisins in a soft 400g loaf for breakfast, snacks, or sandwiches."
  },
  {
    sourceProductId: "P024",
    manufacturerBarcode: "4806502721452",
    description: "Gardenia High Fiber Whole Wheat Bread in a 400g loaf, made for everyday sandwiches, toast, and breakfast meals."
  },
  {
    sourceProductId: "P027",
    manufacturerBarcode: "4800148535992",
    description: "Marby Cheese Bites in a kid-friendly pack, featuring soft bite-sized bread pieces with a savory cheese flavor."
  },
  {
    sourceProductId: "P030",
    manufacturerBarcode: "4800148536791",
    description: "Marby Mini Mamon is a soft, lightly sweet Filipino sponge cake in a convenient 70g snack pack."
  },
  {
    sourceProductId: "P031",
    manufacturerBarcode: "4800148532267",
    description: "Marby Hopia Roll Mongo is a 220g pastry pack filled with sweet mung bean filling and rolled in a soft, flaky crust."
  },
  {
    sourceProductId: "P201",
    manufacturerBarcode: "737552870453",
    description: "Barrio Fiesta Ginisang Bagoong Spicy is sautéed shrimp paste with a spicy savory-sweet flavor in a 250g jar."
  },
  {
    sourceProductId: "P202",
    manufacturerBarcode: "737552870439",
    description: "Barrio Fiesta Ginisang Bagoong Regular is sautéed shrimp paste with a savory-sweet flavor in a 250g jar."
  },
  {
    sourceProductId: "P204",
    manufacturerBarcode: "4800575120303",
    description: "Alaska Classic Sweetened Condensed Filled Milk is a rich and sweet 377g milk product for desserts, drinks, and recipes."
  },
  {
    sourceProductId: "P219",
    manufacturerBarcode: "4800049720114",
    description: "Nature’s Spring Purified Drinking Water is purified bottled water in a convenient 500mL size for everyday hydration."
  },
  {
    sourceProductId: "P238",
    manufacturerBarcode: "4800350108878",
    description: "Pocari Sweat is an ion-supply hydration drink in a 900mL bottle formulated to help replenish water and electrolytes."
  },
  {
    sourceProductId: "P022",
    manufacturerBarcode: "4806502720615",
    description: "Gardenia Enriched White Bread is a soft 600g loaf for everyday sandwiches, toast, breakfast, and snacks."
  },
  {
    sourceProductId: "P074",
    manufacturerBarcode: "4801288850082",
    description: "Those Days Regular With Wings contains 8 sanitary pads designed for regular daytime menstrual protection."
  },
  {
    sourceProductId: "P075",
    manufacturerBarcode: "4801288870080",
    description: "Those Days All Night With Wings contains 8 sanitary pads designed for extended overnight menstrual protection."
  },
  {
    sourceProductId: "P089",
    manufacturerBarcode: "748485900087",
    description: "Fresca Tuna Hot & Spicy is a 175g canned tuna product with a savory hot-and-spicy flavor, ready to pair with rice or meals."
  },
  {
    sourceProductId: "P103",
    manufacturerBarcode: "4800888607119",
    description: "Lady’s Choice Chicken Spread is a creamy chicken-flavored sandwich spread in a convenient 27mL single-use pack."
  },
  {
    sourceProductId: "P122",
    manufacturerBarcode: "4800158987019",
    description: "Hokkaido Mackerel in Oil is a 425g canned mackerel product packed in oil for ready-to-serve meals and cooking."
  },
  {
    sourceProductId: "P141",
    manufacturerBarcode: "4805358317031",
    description: "Magnolia Cheezee is a 160g processed cheese product with a creamy, savory cheese taste for sandwiches, snacks, and cooking."
  },
  {
    sourceProductId: "P317",
    manufacturerBarcode: "4800049720244",
    description: "Nature’s Spring Distilled Drinking Water is distilled water in a large 10-liter container for household drinking-water needs."
  },
  {
    sourceProductId: "P318",
    manufacturerBarcode: "4801981164714",
    description: "Wilkins Distilled Drinking Water is distilled water in a 7-liter container for convenient household hydration."
  },
  {
    sourceProductId: "P397",
    manufacturerBarcode: "4800575144590",
    description: "Alaska Fortified Powdered Milk Drink is a 300g powdered milk drink formulated for everyday family nutrition."
  },
  {
  ...
  },
  {
    ...
    description: "Tuna flakes packed in vegetable oil in a 180g can, ready to serve with rice or use in sandwiches, pasta, and other meals."
  },
  {
    sourceProductId: "P107",
    manufacturerBarcode: "748485800011",
    description: "Ready-to-cook corned beef in a 175g can, fortified with zinc and iron and suitable for everyday rice meals and breakfast dishes."
  },
  {
    sourceProductId: "P177",
    manufacturerBarcode: "4801668500224",
    description: "Filipino-style soy sauce in a 1-liter bottle, used for marinades, dipping sauces, and everyday savory cooking."
  },
  {
    sourceProductId: "P394",
    manufacturerBarcode: "4800361388047",
    description: "Fortified powdered milk drink with essential nutrients for everyday family nutrition, packed in a 900g format."
  },
  {
    sourceProductId: "P266",
    manufacturerBarcode: "4801981111831",
    description: "Carbonated isotonic drink formulated for hydration and refreshment, supplied in a convenient 500mL bottle."
  },
  {
    sourceProductId: "P257",
    manufacturerBarcode: "9556001216786",
    description: "Ready-to-drink apple-flavored green tea with a light, refreshing taste in a 500mL bottle."
  }
