...
test("fresh development startup safely synchronizes the Prisma schema before the backend starts", () => {
  ...
  assert.ok(
    ...
    "the database schema must be synchronized before the backend can accept requests"
  );
