...
| ------ | --------------------------------------- | ------- | -------------------------------------------------------------------- |
| `GET`  | `/api/catalog/products/import/template` | `OWNER` | Download the canonical CSV template                                  |
| `POST` | `/api/catalog/products/import/preview`  | `OWNER` | Validate a CSV or Excel file without writing data                    |
| `POST` | `/api/catalog/products/import`          | `OWNER` | Validate and persist products, inventory rows, and initial movements |
...
- Template download: `/api/catalog/products/import/template`
