...
assert.equal(resolveLegacyProductImageSource(repoRoot, "/images/products/nested/secret.webp"), null);
assert.equal(resolveLegacyProductImageSource(repoRoot, "https://example.com/ligo.webp"), null);
assert.equal(resolveLegacyProductImageSource(repoRoot, "/api/storefront/product-images/abc/card"), null);
