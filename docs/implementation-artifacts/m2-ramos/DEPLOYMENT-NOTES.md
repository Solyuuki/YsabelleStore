...
| 2026-07-11 | Backend<br>Forecasting<br>Frontend<br>Scripts / CI                                          | Deployment/runtime attention required for database, backend, package, Electron, or migration changes. | backend/src/config/env.ts<br>backend/src/modules/forecasting/forecast-window.ts<br>backend/src/modules/forecasting/forecast.schemas.ts<br>backend/src/modules/forecasting/forecast.service.ts<br>backend/src/modules/forecasting/forecast.types.ts<br>backend/src/modules/forecasting/python-forecast-runner.service.ts<br>backend/src/modules/forecasting/spreadsheet-parser.service.ts<br>backend/src/scripts/forecastSmoke.ts |
| 2026-07-11 | Backend<br>Docs<br>Forecasting<br>Frontend<br>Scripts / CI                                  | Deployment/runtime attention required for database, backend, package, Electron, or migration changes. | backend/src/config/env.ts<br>backend/src/modules/forecasting/forecast-window.ts<br>backend/src/modules/forecasting/forecast.schemas.ts<br>backend/src/modules/forecasting/forecast.service.ts<br>backend/src/modules/forecasting/forecast.types.ts<br>backend/src/modules/forecasting/python-forecast-runner.service.ts<br>backend/src/modules/forecasting/spreadsheet-parser.service.ts<br>backend/src/scripts/forecastSmoke.ts |
