...
| YSB-M1-ABARADO-20260818 | Preserve artifact markdown templates during automation updates | Needs Review | sprint/v0.4/sprint-4 | Run push-ready validation and resolve any failures. |
