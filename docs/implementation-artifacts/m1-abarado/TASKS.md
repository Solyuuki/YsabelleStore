...
| YSB-M1-UI-001 | Sprint 1 | m1 - Abarado | React TypeScript frontend shell | `app/frontend/` | Planned | Not run until scaffold exists | Requires approved app setup task |
...
- [ ] Branch name starts with `m1/`
- [ ] Scope is limited to assigned files
