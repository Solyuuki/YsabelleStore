...
| YSB-M1-ABARADO-20260827 | Preserve artifact markdown templates during automation updates | Manual QA Required | m1/v0.9/feat/phase3-phase4-readiness    | Perform manual QA on the changed auth/device/UI flow. |
