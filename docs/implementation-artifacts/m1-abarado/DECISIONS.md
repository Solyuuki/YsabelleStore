...
| DEC-M1-008  | 2026-06-27 | UX      | Align the app shell palette and sidebar structure with the Welcome screen | The dashboard shell needed the same premium desktop tone, clearer navigation grouping, and calmer ambient feel |
| DEC-M1-009  | 2026-06-27 | UX      | Remove the dashboard blue cast and always-on menu badges                  | The app shell needed the warm mint/sage continuation of Welcome branding and only meaningful attention signals |
