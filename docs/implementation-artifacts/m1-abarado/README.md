...
Primary ownership: repository governance, documentation quality, React UI shell, Electron packaging, and desktop release readiness.
...
- [ ] Use valid branch names beginning with `m1/`
- [ ] Record affected files before opening a PR
