...
| BLK-M3-004 | 2026-06-29 | Migration standardization | Existing migration folder used timestamp naming.                                                                   | Repository naming standard required numbered migration folders.                        | Verified Prisma status, renamed the folder to `0001_sprint_1_database_foundation`, and documented the numbered standard. | Resolved                                                      |
...
| ---------- | ------------------ | ------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| WCH-M3-001 | Migration naming   | Future folders must use numbered repository naming.                 | Determine highest sequence and increment before creating migration artifact. |
