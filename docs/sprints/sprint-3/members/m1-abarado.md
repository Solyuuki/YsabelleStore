...
| 2026-07-11 | sprint/v0.3/sprint-3               | Backend<br>Docs<br>Frontend<br>Scripts / CI             | Artifact automation was updated to preserve existing markdown templates and avoid duplicated generated sections. | backend/package.json<br>backend/src/controllers/productController.ts<br>backend/src/controllers/productsController.ts<br>backend/src/routes/product.routes.ts<br>backend/src/services/inventoryService.ts<br>backend/src/services/posService.ts<br>backend/src/services/productImportService.ts<br>backend/src/services/productService.ts                                                                                                                                         | Manual QA required for auth/device/UI flow. |
