...
M1 moved account creation to the owner-only User Management UI, M2 completed backend enforcement, and M3 validated the final behavior through API and UI tests. Sprint 3 now owns the remaining product, inventory, POS, forecasting, and reports work.
