...
| 2026-07-10 | m1/v0.3/feat/pos-sales-integration | Docs<br>Frontend | Auth UI and session UX were updated while preserving trusted-device and route-guard behavior. | docs/sprints/sprint-2/DEFINITION-OF-DONE.md | Manual QA required for auth/device/UI flow. |
