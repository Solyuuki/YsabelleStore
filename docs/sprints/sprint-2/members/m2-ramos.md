...
| 2026-07-11 | m2/v0.3/feat/sarima-forecast-reports | Backend<br>Docs<br>Forecasting<br>Frontend<br>Scripts / CI                                  | Artifact automation was updated to preserve existing markdown templates and avoid duplicated generated sections. | backend/src/config/env.ts<br>backend/src/modules/forecasting/forecast-window.ts<br>backend/src/modules/forecasting/forecast.schemas.ts<br>backend/src/modules/forecasting/forecast.service.ts<br>backend/src/modules/forecasting/forecast.types.ts<br>backend/src/modules/forecasting/python-forecast-runner.service.ts<br>backend/src/modules/forecasting/spreadsheet-parser.service.ts<br>backend/src/scripts/forecastSmoke.ts | Manual QA required for auth/device/UI flow. |
